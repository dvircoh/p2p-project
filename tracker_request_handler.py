...
class RequestHandler:
    ...
    def add_user_handler(self, payload):
        ...
        if self.db.get_id_by_name(name):
            ...
            self.db.save_new_client(user_uuid, name, public_key)
            return [header_struct_generator(RESPONSE_CODE["registered"], UUID_SIZE), struct.pack('<16s', user_uuid)]
